...
u2f.WrappedAuthenticatorPort_.prototype.doResponseFixups_ =
  ...
  if (typeof encodedChallengeObject !== 'undefined') {
    /* websafe base64 to normal base64 */
    var padding = ((4 - encodedChallengeObject.length % 4) % 4);
    for(var i=0; i<padding; i++) {
      encodedChallengeObject += '=';
    }
    encodedChallengeObject = encodedChallengeObject.replace(/_/g, '/').replace(/-/g, '+');
